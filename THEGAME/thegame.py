...
top_wall_img = pygame.transform.scale_by(pygame.image.load("tiles/1.png").convert_alpha(), (1,2))
bottom_wall_img = pygame.transform.scale_by(pygame.image.load("tiles/9.png").convert_alpha(), (1,2))
right_wall_img = pygame.transform.scale_by(pygame.image.load("tiles/2.png").convert_alpha(), (1,2))
left_wall_img = pygame.transform.scale_by(pygame.image.load("tiles/3.png").convert_alpha(), (1,2))
topright_wall_img = pygame.transform.scale_by(pygame.image.load("tiles/4.png").convert_alpha(), (1,2))
topleft_wall_img = pygame.transform.scale_by(pygame.image.load("tiles/6.png").convert_alpha(), (1,2))
left_wall_connect_img = pygame.transform.scale_by(pygame.image.load("tiles/7.png").convert_alpha(), (1,2))
right_wall_connect_img = pygame.transform.scale_by(pygame.image.load("tiles/11.png").convert_alpha(), (1,2))
topright_black_wall_img = pygame.transform.scale_by(pygame.image.load("tiles/8.png").convert_alpha(), (1,2))
topleft_black_wall_img = pygame.transform.scale_by(pygame.image.load("tiles/10.png").convert_alpha(), (1,2))
torch_img = pygame.transform.scale_by(pygame.image.load("tiles/10.png").convert_alpha(), (1,2))
boundary_block_img = pygame.image.load("tiles/skyBlock.png").convert_alpha()
...
#loads images
background = pygame.image.load("newmap.png").convert()
...
class Bullet(pygame.sprite.Sprite):
    def __init__(self, x, y, angle):
        super().__init__()
        self.image = pygame.image.load("bull1.png").convert_alpha()
        self.image = pygame.transform.rotozoom(self.image, 270 - angle, BULL_SIZE)
